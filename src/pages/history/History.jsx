      ...
      <div className="mx-3 mt-16 mb-6 lg:mx-4">
        <div className="">
          ...
          <div className="w-[50rem] grid gap-4 ml-5 max-h-[670px] overflow-y-auto mt-5">
            {data && data.length > 0 &&
              data.map((item) => (
                <div key={item.id} className="w-full border-2 border-[#dee2e6] flex items-center justify-between p-2">
                  {editingItemId === item.id ? (
                    <div className="w-full p-2">
                      <textarea
                        ...
                        className=" w-[45rem] h-[24rem] border border-black rounded-md px-4 mt-8 text-gray-600 p-2"
                      ></textarea>
                      ...
                      <>
                        <div className="">
                          <p textarea className="text-xl font-semibold text-gray-400">{item.text}</p>
