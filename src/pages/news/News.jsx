        ...
        <div className="mt-16 mb-6">
          <div className="flex">
            ...
            >
              <div className="flex items-center gap-2">
                <input
                  type="file"
                  className="w-52 h-10 px-2 py-[3px] text-gray-600 border-2 border-[#dee2e6] bg-white rounded-lg focus:outline-none focus:border-blue-400 ml-5"
                  {...register("image")}
                />
                <input
                  type="text"
                  placeholder="Text"
                  className="w-52 h-10 px-4 py-2 border-2 border-[#dee2e6] rounded-lg focus:outline-none focus:border-blue-400 placeholder-gray-600 ml-2"
                  {...register("text")}
                  defaultValue={""}
                />
                <input
          ...
          <div className="max-h-96 overflow-y-auto ml-5">
            {Array.isArray(data) ? (
              data.map((item) => (
                <div>
                  <div key={item.id} className="mt-5 w-[60rem] border-2 border-[#dee2e6] flex items-center justify-between p-2">
                    <img className="w-20 h-32 object-cover" src={`https://api.abdullajonov.uz/legend-backend-api/public/storage/images/${item.image}`} alt="" />
