            ...
            <form className="" onSubmit={handleSubmit(onSubmit)}>
              <div className="items-center md:flex">
                ...
                <input
                  ...
                  {...register("name")}
                />
                <button type="submit" className="w-[320px] ml-1 mt-3 md:w-52 h-10 px-4 py-2 flex text-center border-2 border-[#dee2e6] text-gray-600 rounded-lg ml-5 hover:bg-blue-400 hover:border-blue-400 hover:text-white">
                ...
                <div className="w-[320px] md:flex w-full items-center justify-evenly border-2 border-[#dee2e6] p-2" key={item.id}>
                  ...
                  {editingId !== null && editingId === item.id && (
                      ...
                      <div className="mt-2 flex gap-11 md:flex gap-11">
                          ...
                          className="w-32 md:flex h-10 w-52 items-center justify-evenly rounded-lg border-2 border-[#dee2e6] px-4 py-2 text-white placeholder-gray-600 focus:outline-none"
                            {...register("name")}
                          />
                        <button type="submit" className="w-32 flex items-center justify-evenly md:w-52 h-10 bg-blue-800 text-white rounded-lg text-center ml-5">
